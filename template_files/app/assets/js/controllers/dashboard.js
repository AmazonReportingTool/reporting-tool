app.controller('DashboardController',
  ...
  $scope.chartData4 = randomData(30, 2, 23);
  */
  //$scope.chartData5 = [2,3,4,2,3,4,5,6,7,8,7,6,4,1,0,0,3,4,5]; //Test Sales
  $scope.chartData1 = randomData(30, 10000, 12000);
  $scope.chartData5 = randomData(20, 0, 10);
  $scope.test = 100; //Test holder
  $scope.test2 = 43050;
